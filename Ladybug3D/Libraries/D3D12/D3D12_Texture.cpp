...
namespace Ladybug3D::D3D12 {
    ...
    VertexBuffer::VertexBuffer(ID3D12Device* device, ID3D12GraphicsCommandList* cmdList, const std::vector<Vertex2>& vertices) {
        UINT vertexDataSize = vertices.size() * sizeof(Vertex2);
        ...
        // Initialize the vertex buffer view.
        m_VertexBufferView.BufferLocation = m_Resource->GetGPUVirtualAddress();
        m_VertexBufferView.StrideInBytes = sizeof(Vertex2);
        m_VertexBufferView.SizeInBytes = vertexDataSize;
    }
